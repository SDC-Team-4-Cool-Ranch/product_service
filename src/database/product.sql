...
CREATE INDEX product_features_id_idx on product_features(product_id);
...
CREATE INDEX styles_id_idx on styles(product_id);
...
CREATE INDEX skus_covering_idx ON skus (id, style_id, size, quantity);
...
CREATE INDEX photo_id_idx on photos(style_id);
